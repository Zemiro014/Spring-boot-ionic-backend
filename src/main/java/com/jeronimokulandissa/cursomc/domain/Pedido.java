...
public class Pedido implements Serializable
{
	...
	@ManyToOne // Tipo de associação entre Pedido e Endereco
	@JoinColumn(name="endereco_de_entrega_id") // declarando o nome da "chave estrangeira" para esta associação
	...
	public Pedido(Integer id, Date instante, Cliente cliente, Endereco enderecoDeEntrega) 
	{
		...
		//this.pagamento = pagamento; Como "Pedido" e "Pagamento" dependem um do outro, então não necessário inicar o "Pagamento" ao instanciar o "Pedido"
